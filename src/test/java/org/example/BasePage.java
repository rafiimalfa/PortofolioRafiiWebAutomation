...
public class BasePage {
    ...
    public void inputURL(String URL) { driver.get(URL); }

    public void inputChar(WebElement e, String charKeyboard) {
        Actions actions = new Actions(driver);
        actions.sendKeys(e, charKeyboard).perform();
    }
    ...
    public void dragAndDrop(WebElement elementStart, WebElement elementFinish) {
        new Actions(driver).dragAndDrop(elementStart, elementFinish).perform();
    }
    ...
    public void keyDown(String charKeyboard) {
        new Actions(driver).keyDown(Keys.SHIFT).sendKeys(charKeyboard).perform();
    }

    public void inputCharOnKeyboard(String inputKeys) {
        new Actions(driver).sendKeys(inputKeys).perform();
    }
